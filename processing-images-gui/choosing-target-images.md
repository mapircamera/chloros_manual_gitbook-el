...
Η επισήμανση των εικόνων που περιέχουν στόχους βαθμονόμησης είναι ένα κρίσιμο βήμα που επιταχύνει σημαντικά τη διαδικασία επεξεργασίας του Chloros. Με την προεπιλογή των εικόνων-στόχων, εξαλείφεται η ανάγκη του Chloros να σαρώσει κάθε εικόνα στο σύνολο δεδομένων σας για στόχους βαθμονόμησης.
...
4. Επαναλάβετε τη διαδικασία για όλες τις εικόνες που περιέχουν στόχους.
...
## Βέλτιστες πρακτικές για εικόνες στόχου

### Οδηγίες λήψης στόχου

**Χρονοδιάγραμμα:**

* Λάβετε εικόνες στόχου αμέσως πριν και κατά τη διάρκεια της συνεδρίας λήψης
...
* [ ] Τουλάχιστον 1 εικόνα στόχου επισημασμένη ανά συνεδρία
* [ ] Τα πλαίσια ελέγχου της στήλης στόχων είναι επιλεγμένα για όλες τις εικόνες στόχων
* [ ] Εικόνες στόχων που έχουν ληφθεί εντός του ίδιου χρονικού διαστήματος με την έρευνα
* [ ] Στόχοι που είναι σαφώς ορατοί στην προεπισκόπηση όταν κάνετε κλικ
