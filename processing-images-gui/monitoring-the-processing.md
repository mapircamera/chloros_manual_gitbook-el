...
* Απλή οριζόντια γραμμή οπτικοποίησης
...
* **Τοποθετήστε τον κέρσορα πάνω από** τη γραμμή προόδου για να δείτε το αναπτυγμένο πάνελ 4 σταδίων
...
* Ανίχνευση: 0% → 100%
* Αριθμός σαρωμένων εικόνων
* Αριθμός εντοπισμένων στόχων
...
* Ελέγξτε το αρχείο καταγραφής σφαλμάτων για μηνύματα &quot;Target found&quot; (Εντοπίστηκε στόχος)
...
* **Ελεύθερη λειτουργία**: Επεξεργασία μιας εικόνας κάθε φορά με τη σειρά
* **Λειτουργία Chloros+**: Επεξεργασία έως και 16 εικόνων ταυτόχρονα
...
* Βεβαιωθείτε ότι ο δίσκος δεν έχει σχεδόν εξαντληθεί (επηρεάζει την ταχύτητα εγγραφής)
...
Για πληροφορίες σχετικά με την εξέταση και τη χρήση των επεξεργασμένων αποτελεσμάτων, ανατρέξτε στο [Ολοκλήρωση της επεξεργασίας](finishing-the-processing.md).
