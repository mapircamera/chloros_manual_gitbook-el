...
* **Κάντε κλικ** στη γραμμή προόδου για να παγώσετε/καρφιτσώσετε το αναπτυγμένο πάνελ
...
Για πληροφορίες σχετικά με την ανασκόπηση και τη χρήση των επεξεργασμένων αποτελεσμάτων, ανατρέξτε στο [Ολοκλήρωση της επεξεργασίας](finishing-the-processing.md).
