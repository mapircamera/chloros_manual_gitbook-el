...
1. Κάντε κλικ στο εικονίδιο **Κύριο μενού** <img src="../.gitbook/assets/image (1) (1) (1) (1).png" alt="" data-size="line"> (πάνω αριστερά)
...
**Συνιστώμενοι προβολείς:*** **QGIS** - Δωρεάν λογισμικό GIS (ιδανικό για γεωαναφερόμενη πολυφασματική ανάλυση)
...
3. Κάντε κλικ στην καρτέλα **Πρόγραμμα προβολής εικόνων** <img src="../.gitbook/assets/icon_image-viewer.JPG" alt="" data-size="line"> στην αριστερή πλευρική γραμμή
...
**Αναμενόμενα εύρη NDVI:*** **Νερό, βράχοι, χώμα**: -0,1 έως 0,2
* **Αραιή/ανθυγιεινή βλάστηση**: 0,2 έως 0,4
* **Μέτρια βλάστηση**: 0,4 έως 0,6
* **Υγιής, πυκνή βλάστηση**: 0,6 έως 0,9**Εάν οι τιμές βρίσκονται εκτός αυτών των εύρων:**
...
3. **Χρησιμοποιήστε εικόνες δείκτη** (NDVI, NDRE) ως έτοιμα προς χρήση στρώματα βλάστησης
...
**Τι να αποθηκεύσετε:*** ✅ **Αρχικές εικόνες RAW/JPG** - Αρχειοθετήστε σε ξεχωριστό δίσκο/cloud
...
* ✅ **Εικόνες στόχου βαθμονόμησης** - Για επαλήθευση και επανεπεξεργασία**Συστάσεις αποθήκευσης:*** **Άμεση δημιουργία αντιγράφων ασφαλείας**: Εξωτερικός σκληρός δίσκος
...
1. **Αποθήκευση προτύπου έργου** (εάν δεν το έχετε κάνει ήδη)
...
Για πολλαπλές συνεδρίες/σύνολα δεδομένων:**Επιλογή 1: GUI - Πολλαπλά έργα**
...
4. ✅ **Επισήμανση στόχων** - Δείτε [Επιλογή εικόνων-στόχων](choosing-target-images.md)
5. ✅ **Έναρξη επεξεργασίας** - Δείτε [Έναρξη της επεξεργασίας](starting-the-processing.md)
6. ✅ **Παρακολούθηση προόδου** - Δείτε [Παρακολούθηση της επεξεργασίας](monitoring-the-processing.md)
7. ✅ **Αναθεώρηση αποτελεσμάτων** - Αυτή η σελίδα**Οι βαθμονομημένες, διορθωμένες ως προς την ανακλαστικότητα πολυφασματικές εικόνες σας είναι έτοιμες για ανάλυση!**
...
* [**Sandbox ευρετηρίου/LUT**](../image-viewer-gui/index-lut-sandbox.md) - Προσαρμοσμένη δοκιμή ευρετηρίου
* [**Τύποι ευρετηρίου πολυφασματικών εικόνων**](../project-settings/multispectral-index-formulas.md) - Πλήρης αναφορά ευρετηρίου

### Αυτοματοποίηση και ενσωμάτωση

* [**Τεκμηρίωση CLI**](../CLI.md) - Μαζική επεξεργασία γραμμής εντολών
