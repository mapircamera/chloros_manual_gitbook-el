...
4. Εντοπίστε το έργο σας με βάση το όνομά του
...
1. **Εισαγάγετε τις εικόνες βαθμονόμησης ανακλαστικότητας** στο λογισμικό φωτογραμμετρίας:
   * Pix4Dmapper
   * Agisoft Metashape
   * DroneDeploy
   * WebODM
...
2. **Εξαγάγετε στατιστικά στοιχεία**: Μέσος όρος NDVI ανά πεδίο/οικόπεδο
...
* [**Python SDK**](../api-python-sdk.md) - Αυτοματοποίηση προγραμμάτων
