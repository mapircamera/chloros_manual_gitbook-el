...
* Εικονίδιο: **Κουμπί Αναπαραγωγή/Έναρξη** <img src="../.gitbook/assets/image (2) (1).png" alt="" data-size="line">
...
2. **Επεξεργασία** - Εφαρμογή βαθμονόμησης και εξαγωγή εικόνων.**Χρόνος επεξεργασίας:**

* Πολύ πιο αργή από τη λειτουργία Chloros+ παράλληλη λειτουργία
...
2. **Ανάλυση** - Εξέταση μεταδεδομένων εικόνας και προετοιμασία pipeline
3. **Καλιμπράρισμα** - Εφαρμογή διορθώσεων και καλιμπραρίσματος
4. **Εξαγωγή** - Αποθήκευση επεξεργασμένων εικόνων και δεικτών**Αλληλεπίδραση γραμμής προόδου:*** **Τοποθετήστε το ποντίκι** πάνω από τη γραμμή για να δείτε λεπτομερές αναπτυσσόμενο πάνελ 4 σταδίων
* **Κάντε κλικ** στη γραμμή προόδου για να παγώσετε το αναπτυσσόμενο πάνελ στη θέση του
* **Κάντε ξανά κλικ** για να ξεπαγώσετε και να αποκρύψετε το πλαίσιο**Χρόνος επεξεργασίας:**
...
* Καταγράφει χρονικές σημάνσεις στόχων για προγραμματισμό βαθμονόμησης
...
**Τι κάνει το Chloros:*** **Διόρθωση βινιέτας**: Αφαιρεί το σκούρο χρώμα του φακού στα άκρα
...
* Οι ενημερώσεις προόδου εμφανίζονται σε πραγματικό χρόνο
...
### Προσέγγιση εκτιμήσεων (Chloros+, εικόνες 12MP, σύγχρονη CPU)
...
1. Περιμένετε να αρχικοποιηθεί πλήρως το backend (ελέγξτε το εικονίδιο του κύριου μενού)
...
2. **Ελέγξτε τον διαθέσιμο χώρο στο δίσκο** - Βεβαιωθείτε ότι έχετε ελεύθερο χώρο 2-3 φορές μεγαλύτερο από το μέγεθος του συνόλου δεδομένων
...
1. **Αποφύγετε την αναστολή λειτουργίας του συστήματος** - Απενεργοποιήστε τις λειτουργίες εξοικονόμησης ενέργειας.
