...
3. Το κουμπί απενεργοποιείται (γκρι) κατά τη διάρκεια της επεξεργασίας
...
* **Τοποθετήστε το ποντίκι** πάνω από τη γραμμή για να δείτε το αναπτυσσόμενο πλαίσιο με λεπτομέρειες για τα 4 στάδια
...
* Εφαρμόζει αλγόριθμο αποσυναρμολόγησης υψηλής ποιότητας
...
* Τη ταχύτητα της CPU και τον αριθμό των πυρήνων
* Τη διαθεσιμότητα της GPU (μόνο Chloros+)
* Τον αριθμό των δεικτών που πρέπει να υπολογιστούν
* Την πολυπλοκότητα της μορφής εξαγωγής
...
3. **Κλείστε τις περιττές εφαρμογές** - Απελευθερώστε πόρους του συστήματος
