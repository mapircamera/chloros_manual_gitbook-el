...
* Εξάγει εικόνες δείκτη με διαμορφωμένα χρώματα LUT
...
* Υψηλή χρήση CPU (πολλαπλής ροής, έως 16 πυρήνες)
...
* Αποφύγετε την εκκίνηση άλλων εργασιών που απαιτούν μεγάλη χρήση της CPU

{% hint style=&quot;warning&quot; %}
**Συμβουλή απόδοσης**: Για βέλτιστη απόδοση του Chloros+, κλείστε άλλες εφαρμογές και αφήστε το Chloros να χρησιμοποιήσει όλους τους πόρους του συστήματος.
{% endhint %}
...
**Συμβουλή προγραμματισμού:** Για πολύ μεγάλα έργα, εξετάστε το ενδεχόμενο επεξεργασίας σε παρτίδες ή χρήσης του CLI για καλύτερο έλεγχο.
...
* **Να παρακολουθήσετε τη γραμμή προόδου** - Να δείτε το συνολικό ποσοστό ολοκλήρωσης
* **Να δείτε το τρέχον στάδιο** - Ανίχνευση, ανάλυση, βαθμονόμηση ή εξαγωγή
* **Να ελέγξετε την καρτέλα καταγραφής** - Να δείτε λεπτομερή μηνύματα και προειδοποιήσεις επεξεργασίας
...
3. Η επεξεργασία διακόπτεται αμέσως
4. Τα μερικά αποτελέσματα απορρίπτονται

### Πότε να ακυρώσετε

**Έγκυροι λόγοι για ακύρωση:**
...
* Για την καλύτερη δυνατή εμπειρία, κλείστε εντελώς το Chloros και επανεκκινήστε
...
* Την ταχύτητα της CPU και τον αριθμό των πυρήνων
* Τη διαθεσιμότητα της GPU (μόνο Chloros+)
* Αριθμός δεικτών προς υπολογισμό
* Πολυπλοκότητα μορφής εξαγωγής

### Προσέγγιστες εκτιμήσεις (Chloros+, εικόνες 12MP, σύγχρονος επεξεργαστής CPU)
...
{% hint style=&quot;info&quot; %}
**Πρώτη εκτέλεση**: Η αρχική επεξεργασία ενδέχεται να διαρκέσει περισσότερο, καθώς το Chloros δημιουργεί cache και προφίλ. Η επακόλουθη επεξεργασία παρόμοιων συνόλων δεδομένων θα είναι ταχύτερη.
{% endhint %}
...
## Συμβουλές για επιτυχημένη επεξεργασία
