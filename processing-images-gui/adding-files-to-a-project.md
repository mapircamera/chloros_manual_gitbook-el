...
1. Κάντε κλικ στο κουμπί **&quot;Προσθήκη φακέλου&quot;** στο επάνω μέρος του πλαισίου του προγράμματος περιήγησης αρχείων.
...
* **Ταξινόμηση κατά χρονολογική σειρά**: Χρήσιμο για την οργάνωση χρονολογικών ακολουθιών λήψης
...
3. Μεταβείτε μεταξύ των εικόνων χρησιμοποιώντας τα βελάκια

### Γρήγορη πλοήγηση

* **Προηγούμενη εικόνα**: Κάντε κλικ στο αριστερό βελάκι ή πατήστε το πλήκτρο ←
* **Επόμενη εικόνα**: Κάντε κλικ στο δεξί βελάκι ή πατήστε το πλήκτρο →
* **Μεγέθυνση/Σμίκρυνση**: Χρησιμοποιήστε τον τροχό του ποντικιού ή τα κουμπιά μεγέθυνσης
* **Περιστροφή**: Κάντε κλικ και σύρετε την εικόνα όταν είναι μεγεθυμένη
