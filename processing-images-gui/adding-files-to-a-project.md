...
{% hint style="info" %}
**Υποστηριζόμενοι τύποι αρχείων**: Το Chloros υποστηρίζει αρχεία εικόνων RAW+JPG και JPG από τις κάμερες MAPIR Survey3W και Survey3N. Συνιστάται μόνο η χρήση RAW+JPG.
{% endhint %}
...
Χρησιμοποιήστε αυτήν την επιλογή για να εισαγάγετε μεμονωμένα αρχεία εικόνας ή μια μικρή επιλογή αρχείων.

1. Κάντε κλικ στο κουμπί **&quot;Προσθήκη αρχείων&quot;** <img src="../.gitbook/assets/image.png" alt="" data-size="line"> στην κορυφή του πλαισίου του προγράμματος περιήγησης αρχείων
...
1. Κάντε κλικ στο κουμπί **&quot;Προσθήκη φακέλου&quot;** <img src="../.gitbook/assets/image (1).png" alt="" data-size="line"> στην κορυφή του πλαισίου του προγράμματος περιήγησης αρχείων.
...
* Αυτόματη ανίχνευση της κάμερας και της διαμόρφωσης του φίλτρου
...
### Προβολή μεταδεδομένων εικόνας

Κάνοντας κλικ στο κουμπί εναλλαγής στην επάνω δεξιά γωνία πάνω από τον πίνακα, εμφανίζονται τα μεταδεδομένα της επιλεγμένης εικόνας στην περιοχή πλέγματος εικόνων.
...
2. Κάντε κλικ στο κουμπί **&quot;Κατάργηση επιλεγμένων&quot;** <img src="../.gitbook/assets/image (2).png" alt="" data-size="line"> .
3. Επιβεβαιώστε τη διαγραφή (τα αρχεία δεν διαγράφονται από το δίσκο, αλλά αφαιρούνται μόνο από το έργο).
...
* **Μετακίνηση**: Κάντε κλικ και σύρετε την εικόνα όταν μεγεθύνετε
...
* Εμφανίζεται προειδοποιητικό μήνυμα όταν εντοπίζονται διπλότυπα
...
3. Το πρόγραμμα περιήγησης αρχείων εμφανίζει το μοντέλο της κάμερας στη στήλη Μοντέλο κάμερας
...
2. **Ελέγξτε τα μοντέλα της κάμερας** - Βεβαιωθείτε ότι η κάμερα έχει αναγνωριστεί σωστά
3. **Επισημάνετε τις εικόνες-στόχους** - Δείτε [Επιλογή εικόνων-στόχων](choosing-target-images.md)
