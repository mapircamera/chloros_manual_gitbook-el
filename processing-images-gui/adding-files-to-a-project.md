...
3. Ο πίνακας του File Browser θα εμφανίσει τη λίστα αρχείων του έργου σας

{% hint style=&quot;info&quot; %}
**Υποστηριζόμενοι τύποι αρχείων**: Το Chloros υποστηρίζει αρχεία εικόνας RAW+JPG και JPG από τις κάμερες MAPIR Survey3W και Survey3N. Συνιστάται μόνο η χρήση RAW+JPG.
{% endhint %}
...
Χρησιμοποιήστε αυτήν την επιλογή για να εισαγάγετε όλες τις εικόνες από έναν φάκελο ταυτόχρονα.

1. Κάντε κλικ στο κουμπί **&quot;Προσθήκη φακέλου&quot;** <img src="../.gitbook/assets/image (1).png" alt="" data-size="line"> στην κορυφή του πίνακα του προγράμματος περιήγησης αρχείων.
...
3. Επιβεβαιώστε την αφαίρεση (τα αρχεία δεν διαγράφονται από το δίσκο, αλλά αφαιρούνται μόνο από το έργο).
...
* **Πανόραμα**: Κάντε κλικ και σύρετε την εικόνα όταν μεγεθύνετε***
