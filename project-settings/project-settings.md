...
* **Προεπιλογή**: 25 pixel
* **Περιγραφή**: Ορίζει την ελάχιστη περιοχή (σε pixel) που απαιτείται για να θεωρηθεί μια ανιχνευθείσα περιοχή ως έγκυρο δείγμα στόχου βαθμονόμησης. Οι μικρότερες τιμές θα ανιχνεύουν μικρότερους στόχους, αλλά ενδέχεται να αυξήσουν τα ψευδώς θετικά αποτελέσματα. Οι μεγαλύτερες τιμές απαιτούν μεγαλύτερες, σαφέστερες περιοχές στόχων για ανίχνευση.
...
* **Πότε να προσαρμόσετε**:
  * Αυξήστε την τιμή εάν οι στόχοι βαθμονόμησης χωρίζονται σε πολλαπλές ανιχνεύσεις.
  * Μειώστε την τιμή εάν οι στόχοι βαθμονόμησης με χρωματική ποικιλία δεν ανιχνεύονται πλήρως.
...
* **Προεπιλογή**: Ενεργοποιημένο (επιλεγμένο)
* **Περιγραφή**: Εφαρμόζει διόρθωση βινιέτας για να αντισταθμίσει το σκούρο χρώμα του φακού στα άκρα των εικόνων. Η βινιέτα είναι ένα συνηθισμένο οπτικό φαινόμενο όπου οι γωνίες και τα άκρα μιας εικόνας εμφανίζονται πιο σκούρα από το κέντρο λόγω των χαρακτηριστικών του φακού.
* **Πότε να απενεργοποιήσετε**: Απενεργοποιήστε μόνο εάν ο συνδυασμός κάμερας/φακού έχει ήδη εφαρμόσει διόρθωση βινιέτας ή εάν θέλετε να διορθώσετε χειροκίνητα τη βινιέτα κατά την μετα-επεξεργασία.
...
* **Περιγραφή**: Ενεργοποιεί τη χρήση διορθώσεων Post-Processed Kinematic (PPK) από καταγραφείς MAPIR DAQ που περιέχουν GPS (GNSS). Όταν είναι ενεργοποιημένο, το Chloros θα χρησιμοποιεί όλα τα αρχεία καταγραφής .daq που περιέχουν δεδομένα ακίδων έκθεσης στον κατάλογο του έργου σας και θα εφαρμόζει ακριβείς διορθώσεις γεωγραφικής θέσης στις εικόνες σας.
...
* **Τύπος**: Ειδικός πίνακας διαμόρφωσης δείκτη
...
### Προσαρμοσμένοι τύποι (Χαρακτηριστικό Chloros+)

* **Τύπος**: Πίνακας ορισμών προσαρμοσμένων τύπων
* **Περιγραφή**: Σας επιτρέπει να δημιουργείτε και να αποθηκεύετε προσαρμοσμένους τύπους πολυφασματικών δεικτών χρησιμοποιώντας μαθηματικές συναρτήσεις ζώνης. Οι προσαρμοσμένοι τύποι αποθηκεύονται με τις ρυθμίσεις του έργου σας και μπορούν να χρησιμοποιηθούν όπως οι ενσωματωμένοι δείκτες.
...
4. **Χειροκίνητες προσαρμογές** - Οποιεσδήποτε αλλαγές κάνετε κατά τη διάρκεια της τρέχουσας περιόδου λειτουργίας

### Ρυθμίσεις και επεξεργασία εικόνων
