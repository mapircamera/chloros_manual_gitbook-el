...
Η ύπαρξη ευρέων NIR και πράσινων μηκών κύματος παρέχει καλύτερη πρόβλεψη της περιεκτικότητας σε χλωροφύλλη, ενώ επιτρέπει μεγαλύτερη ευαισθησία και υψηλότερο λόγο σήματος προς θόρυβο.
...
Αυτός ο δείκτης σχεδιάστηκε αρχικά για χρήση με ψηφιακή κάμερα RGB για τη μέτρηση της κάλυψης σιταριού, όπου οι ψηφιακοί αριθμοί (DN) κόκκινου, πράσινου και μπλε χρώματος κυμαίνονται από 0 έως 255.
...
_Αναφορά: Sripada, R., et al. «Αεροφωτογραφία με έγχρωμο υπέρυθρο για τον προσδιορισμό των απαιτήσεων αζώτου κατά τη διάρκεια της καλλιεργητικής περιόδου για το καλαμπόκι». Agronomy Journal 98 (2006): 968-977._
...
Αυτός ο δείκτης χρησιμοποιείται για την εκτίμηση της περιεκτικότητας σε χλωροφύλλη σε ανώτερα φυτά, ευαίσθητα στις διακυμάνσεις της ανακλαστικότητας που προκαλούνται από την απορρόφηση της χλωροφύλλης.
...
## RDVI - Δείκτης βλάστησης ανακανονικοποιημένης διαφοράς

Αυτός ο δείκτης χρησιμοποιεί τη διαφορά μεταξύ των μηθέρων και των ερυθρών μητρών, μαζί με τον NDVI, για να επισημάνει την υγιή βλάστηση. Είναι αδιάφορος στις επιδράσεις του εδάφους και της γεωμετρίας της θέασης του ήλιου.
...
## TDVI - Μετασχηματισμένος δείκτης διαφοράς βλάστησης
