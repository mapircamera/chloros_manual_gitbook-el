...
Αυτός ο δείκτης αναπτύχθηκε αρχικά για χρήση με δεδομένα MODIS ως βελτίωση του NDVI, βελτιστοποιώντας το σήμα βλάστησης σε περιοχές με υψηλό δείκτη φυλλώματος (LAI). Είναι ιδιαίτερα χρήσιμο σε περιοχές με υψηλό LAI όπου το NDVI μπορεί να κορεστεί. Χρησιμοποιεί την περιοχή ανακλαστικότητας του μπλε χρώματος για να διορθώσει τα σήματα του εδάφους και να μειώσει τις ατμοσφαιρικές επιδράσεις, συμπεριλαμβανομένης της σκέδασης των αερολυμάτων.
...
Ο δείκτης αυτός διακρίνει τα δασικά φύλλωμα από άλλους τύπους βλάστησης χρησιμοποιώντας πολυφασματικές εικόνες ανακλαστικότητας που δεν περιλαμβάνουν κόκκινη ζώνη.
...
_Αναφορά: Yang, Z., P. Willis και R. Mueller. «Impact of Band-Ratio Enhanced AWIFS Image to Crop Classification Accuracy» (Επίδραση της εικόνας AWIFS με βελτιωμένη αναλογία ζωνών στην ακρίβεια ταξινόμησης των καλλιεργειών). Πρακτικά του Συμποσίου Τηλεπισκόπησης Pecora 17 (2008), Ντένβερ, Κολοράντο._
...
Αυτός ο δείκτης χρησιμοποιεί τη διαφορά μεταξύ των μηχανογραφικών και των ερυθρών μηχανογραφικών μήκων κύματος, μαζί με τον NDVI, για να επισημάνει την υγιή βλάστηση. Είναι αδιάφορος στις επιδράσεις του εδάφους και της γεωμετρίας της ηλιακής θέασης.
...
_Gitelson, A. «Δείκτης βλάστησης ευρείας δυναμικής κλίμακας για την απομακρυσμένη ποσοτικοποίηση των βιοφυσικών χαρακτηριστικών της βλάστησης». Journal of Plant Physiology 161, No. 2 (2004): 165-173._
