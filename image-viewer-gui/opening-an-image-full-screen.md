...
2. Ανοίγει η καρτέλα Προβολή εικόνων, εμφανίζοντας την επιλεγμένη εικόνα σε πλήρη οθόνη
3. Τα προηγμένα εργαλεία προβολής και ανάλυσης γίνονται διαθέσιμα στην αριστερή πλευρική γραμμή

***

## Επισκόπηση διεπαφής Προβολή εικόνων
...
* **Με δυνατότητα μεγέθυνσης**: Χρησιμοποιήστε τα χειριστήρια ή τον τροχό του ποντικιού για μεγέθυνση
* **Με δυνατότητα μετακίνησης**: Κάντε κλικ και σύρετε για να μετακινηθείτε όταν έχετε μεγεθύνει
...
Ρυθμίστε τη μεγέθυνση για να εξετάσετε τις λεπτομέρειες της εικόνας:
...
4. Αφήστε το κουμπί για να σταματήσετε τη μετακίνηση

**Εναλλακτική λύση**: Χρησιμοποιήστε τα βελάκια για να μετακινήσετε την εικόνα σε μικρά βήματα

***

## Επιθεώρηση τιμών pixel
...
* **Όταν μεγεθύνετε περαιτέρω, κινητή τιμή κοντά στο δρομέα και επισημασμένο pixel**
* Εμφανίζει τιμές για pixel **κάτω από το δρομέα ή επισημασμένο**
...
**Εικόνες JPG από την κάμερα:**

* Εμφάνιση δεδομένων JPG όπως προβάλλεται
...
* Μπορεί να εφαρμόσει χρωματικές LUT για οπτικοποίηση

***

## Εφαρμογή δείκτη και LUT

Εφαρμόστε πολυφασματικούς δείκτες και χρωματικές πίνακες αναζήτησης:
...
1. Δοκιμάστε να ανοίξετε την εικόνα σε εξωτερικό πρόγραμμα προβολής για να επαληθεύσετε την ακεραιότητα του αρχείου.
2. Ελέγξτε ότι η μορφή του αρχείου αντιστοιχεί στον αναμενόμενο τύπο.
3. Κλείστε άλλες εφαρμογές για να ελευθερώσετε μνήμη.
4. Δοκιμάστε μια μικρότερη/διαφορετική εικόνα.

### Εικόνα εμφανίζεται μαύρη ή λευκή

**Πιθανές αιτίες:**

* Το εύρος τιμών υπερβαίνει τις δυνατότητες της οθόνης.
* Εικόνα 32-bit float με ασυνήθιστες τιμές.
* Σφάλμα υπολογισμού δείκτη.

**Λύσεις:**

1. Ελέγξτε τις τιμές των εικονοστοιχείων - εάν όλες είναι πολύ χαμηλές ή πολύ υψηλές, προσαρμόστε το εύρος εμφάνισης
