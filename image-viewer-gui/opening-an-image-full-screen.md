...
* **Πλήρης ανάλυση**: Εικόνες που εμφανίζονται σε εγγενή ανάλυση
...
2. Κάντε κλικ και **κρατήστε πατημένο το αριστερό πλήκτρο του ποντικιού**
...
1. Ελέγξτε τις τιμές των pixel - εάν είναι όλες πολύ χαμηλές ή πολύ υψηλές, προσαρμόστε το εύρος εμφάνισης
...
### Οι τιμές των pixel φαίνονται λανθασμένες
...
3. Συγκρίνετε με εικόνες γνωστής ποιότητας από το ίδιο σύνολο δεδομένων
...
* [**Sandbox δείκτη/LUT**](index-lut-sandbox.md) - Εφαρμόστε προσαρμοσμένους δείκτες και αντιστοίχιση χρωμάτων
