...
* **Καλιμπραρισμένα** αποτελέσματα ανάκλασης (εάν η καλιμπράρισμα ανάκλασης ήταν ενεργοποιημένο)
* **Εικόνες στόχου** (εάν η εικόνα περιέχει στόχους καλιμπραρίσματος)
...
* Έλεγχος της ποιότητας των αρχικών δεδομένων αισθητήρα
* Έλεγχος για προβλήματα αισθητήρα ή τεχνητά στοιχεία
* Σύγκριση των αποτελεσμάτων πριν και μετά την επεξεργασία

### RAW (Στόχος)

* Εμφανίζεται μόνο για εικόνες που έχουν αναγνωριστεί ως εικόνες που περιέχουν στόχους βαθμονόμησης
...
* Επιβεβαίωση της σωστής ανίχνευσης των στόχων βαθμονόμησης
* Έλεγχος της ποιότητας της εικόνας του στόχου
...
* Επαλήθευση ποιότητας βαθμονόμησης
* Έλεγχος τιμών pixel για επιστημονική ακρίβεια
...
5. Πολύ αποτελεσματικό για την αναθεώρηση των αποτελεσμάτων του δείκτη σε πολλές εικόνες
...
3. Ενεργοποιήστε τη λειτουργία **Pixel Percent** (κουμπί στην επάνω δεξιά γωνία της γραμμής εργαλείων)
4. Μετακινήστε τον κέρσορα πάνω από τις περιοχές βλάστησης
5. Επαληθεύστε ότι οι τιμές pixel βρίσκονται στα αναμενόμενα εύρη (30-70% για NIR, 5-15% για Red)
...
* Η βαθμονόμηση ανάκλασης απενεργοποιήθηκε κατά τη διάρκεια της επεξεργασίας
...
1. Βεβαιωθείτε ότι η εικόνα έχει υποστεί επεξεργασία (ελέγξτε το φάκελο εξόδου για τα αρχεία που έχουν υποστεί επεξεργασία)
...
### Δεν είναι ορατοί οι στόχοι βαθμονόμησης
...
* Η εικόνα δεν περιέχει πραγματικά στόχους
* Οι ρυθμίσεις ανίχνευσης στόχων είναι πολύ αυστηρές

**Λύσεις:**

1. Ελέγξτε το αρχείο καταγραφής σφαλμάτων για μηνύματα &quot;Στόχος βρέθηκε&quot;
...
* **Επιθεώρηση τιμών pixel**: Δείτε τις τιμές στη θέση του δρομέα
