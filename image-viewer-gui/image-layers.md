...
Το αναπτυσσόμενο μενού Image Layers (Επίπεδα εικόνας) στο πρόγραμμα προβολής εικόνων Chloros σάς επιτρέπει να εναλλάσσεστε γρήγορα μεταξύ διαφορετικών εκδόσεων της ίδιας εικόνας - από τις αρχικές λήψεις έως τις επεξεργασμένες εκτυπώσεις ανακλαστικότητας και τις υπολογισμένες εικόνες δείκτη.
...
* **Εξόδους με βαθμονομημένη ανακλαστικότητα** (εάν η βαθμονόμηση ανακλαστικότητας ήταν ενεργοποιημένη)
* **Εικόνες στόχους** (εάν η εικόνα περιέχει στόχους βαθμονόμησης)
* **Εικόνες ευρετηρίου** (NDVI, NDRE, GNDVI, κ.λπ. εάν τα ευρετήρια είχαν διαμορφωθεί)
...
* Έλεγχος της ποιότητας των αρχικών δεδομένων του αισθητήρα
* Έλεγχος για προβλήματα αισθητήρα ή τεχνητά στοιχεία
* Σύγκριση αποτελεσμάτων πριν/μετά την επεξεργασία
...
{% hint style=&quot;info&quot; %}
**Στρώμα στόχου**: Αυτό το στρώμα εμφανίζεται μόνο στο αναπτυσσόμενο μενού για εικόνες που περιέχουν στόχους βαθμονόμησης. Οι κανονικές εικόνες λήψης δεν θα έχουν αυτήν την επιλογή.
{% endhint %}
...
* Οι τιμές των εικονοστοιχείων αντιπροσωπεύουν το ποσοστό αντανάκλασης (όταν χρησιμοποιείται η λειτουργία ποσοστού)
...
{% hint style=&quot;success&quot; %}
**Συνιστάται**: Χρησιμοποιήστε το επίπεδο RAW (αντανάκλαση) κατά τον έλεγχο των τιμών των εικονοστοιχείων για επιστημονικές μετρήσεις και αναλύσεις.
{% endhint %}
...
* Εξετάζοντας τα αποτελέσματα του υπολογισμού του δείκτη
* Ελέγχοντας τα εύρη τιμών του δείκτη
* Προσδιορίζοντας περιοχές ενδιαφέροντος
* Επαληθεύοντας τις εικόνες του δείκτη πριν από τη χρήση τους σε GIS ή ανάλυση
...
* ⚠️ RAW (Πρωτότυπο) - Μόνο εάν η εικόνα τραβήχτηκε σε λειτουργία RAW ή RAW+JPG
* ⚠️ RAW (Στόχος) - Μόνο εάν η εικόνα περιέχει ανιχνευμένους στόχους βαθμονόμησης
...
Όταν πλοηγείστε σε μια διαφορετική εικόνα (χρησιμοποιώντας τα βελάκια ή κάνοντας κλικ στις μικρογραφίες):
...
5. Πολύ αποτελεσματικό για την ανασκόπηση των αποτελεσμάτων του ευρετηρίου σε πολλές εικόνες
...
3. Σημειώστε το βινιετάρισμα και τις μη βαθμονομημένες τιμές
4. Μεταβείτε στο **RAW (Reflectance)** από το αναπτυσσόμενο μενού
5. Συγκρίνετε - το βινιετάρισμα έχει αφαιρεθεί, οι τιμές έχουν βαθμονομηθεί
...
3. Επαληθεύστε ότι οι στόχοι βαθμονόμησης είναι σαφώς ορατοί και έχουν ανιχνευθεί
...
* **Χρήση**: Μόνο οπτική επιθεώρηση, όχι για επιστημονική μέτρηση
...
* **Σημασία**: Βαθμονομημένο ποσοστό αντανάκλασης
* **Χρήση**: Επιστημονικές μετρήσεις και ανάλυση

**Για 16-bit TIFF:** Διαιρέστε με 65.535 για να λάβετε το ποσοστό ανακλαστικότητας **Για 32-bit Percent:** Οι τιμές αντιπροσωπεύουν άμεσα το ποσοστό (0,5 = 50% ανακλαστικότητα)
...
2. Ελέγξτε τις Ρυθμίσεις έργου για να βεβαιωθείτε ότι έχουν διαμορφωθεί οι δείκτες
...
**Αιτία**: Η προτίμηση επιπέδου από την προηγούμενη εικόνα μεταφέρθηκε, αλλά το επίπεδο αυτό δεν υπάρχει στην τρέχουσα εικόνα
...
* **Χειριστήρια ζουμ**: Μεγεθύνετε για να ελέγξετε τις λεπτομέρειες
* **Πανόραμα**: Κάντε κλικ και σύρετε για να μετακινηθείτε στην μεγεθυμένη εικόνα
* **Επιθεώρηση τιμής pixel**: Δείτε τις τιμές στη θέση του δρομέα
* **Βέλη πλοήγησης**: Μετακινηθείτε μεταξύ εικόνων διατηρώντας το επίπεδο
...
* [**Index/LUT Sandbox**](index-lut-sandbox.md) - Διαδραστική οπτικοποίηση δεικτών
