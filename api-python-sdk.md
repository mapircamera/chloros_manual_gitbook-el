...
{% hint style=&quot;warning&quot; %}
**Απαιτήσεις άδειας χρήσης**: Το Python SDK απαιτεί συνδρομή επί πληρωμή Chloros+ για πρόσβαση στο API. Τα βασικά (δωρεάν) πακέτα δεν έχουν πρόσβαση στο API/SDK. Επισκεφθείτε το [https://cloud.mapir.camera/pricing](https://cloud.mapir.camera/pricing) για αναβάθμιση.
{% endhint %}
...
Κύρια τάξη για τοπική επεξεργασία εικόνας Chloros.
...
Σταθερή διαχείριση σφαλμάτων για χρήση σε παραγωγή:
...
* Οι τελικοί χρήστες πρέπει να διαθέτουν ενεργές άδειες χρήσης Chloros+
