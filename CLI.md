...
Chloros+ CLI **αυτοματοποιημένη κλιμάκωση** της παράλληλης επεξεργασίας ανάλογα με τις δυνατότητες του υπολογιστή σας:
...
**Τι κάνει:** Διορθώνει την πτώση του φωτός στις άκρες της εικόνας (σκούρες γωνίες που είναι συχνές στις εικόνες της κάμερας).
...
4. **Έξοδος**: Δημιουργεί υποφακέλους μοντέλων φωτογραφικών μηχανών με τις επεξεργασμένες εικόνες
