...
* ⚡ **Παράλληλη επεξεργασία** - Δυναμική κλιμάκωση ανάλογα με τον επεξεργαστή σας (έως 16 παράλληλοι εργαζόμενοι)
...
| `--recal-interval`    | Ακέραιος | Αυτόματο           | Διάστημα επανακαλιμπραρίσματος σε δευτερόλεπτα                                                      |
...
Chloros+ CLI **προσαρμόζει αυτόματα** την παράλληλη επεξεργασία ώστε να ταιριάζει με τις δυνατότητες του υπολογιστή σας:
...
* Χρησιμοποιήστε `--no-reflectance` για να την απενεργοποιήσετε.
...
* Απαιτεί αρχεία .daq στο φάκελο έργου από τον αισθητήρα φωτός MAPIR DAQ-A-SD.
...
Προβάλετε τις πληροφορίες βοήθειας απευθείας στο CLI:
